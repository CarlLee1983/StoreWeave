...
const zhTW = {
  navigation: '主要導覽', commerce: 'Commerce', integrations: 'Integrations', orders: '訂單', products: '商品', erpQueue: 'ERP 佇列', systemHealth: '系統健康度', online: 'Online',
  ...
  ordersTitle: '訂單管理', ordersSubtitle: '即時交易流與 ERP 投遞管線', productsTitle: '商品管理', productsSubtitle: '管理商品目錄、售價與可用庫存', createProduct: '建立商品', erpTitle: 'ERP 投遞', erpSubtitle: '追蹤訂單事件、重試與 Dead Letter Queue', systemTitle: '系統狀態', systemSubtitle: '服務相依性、擴充套件與銷售匯總',
...
const enUS: Messages = {
  navigation: 'Main navigation', commerce: 'Commerce', integrations: 'Integrations', orders: 'Orders', products: 'Products', erpQueue: 'ERP queue', systemHealth: 'System health', online: 'Online',
  ...
  ordersTitle: 'Order management', ordersSubtitle: 'Live transaction flow and ERP delivery pipeline', productsTitle: 'Product management', productsSubtitle: 'Manage product catalog, prices, and available stock', createProduct: 'Create product', erpTitle: 'ERP delivery', erpSubtitle: 'Track order events, retries, and the dead-letter queue', systemTitle: 'System status', systemSubtitle: 'Service dependencies, extensions, and sales summary',
...
const jaJP: Messages = {
  navigation: 'メインナビゲーション', commerce: 'Commerce', integrations: 'Integrations', orders: '注文', products: '商品', erpQueue: 'ERP キュー', systemHealth: 'システムヘルス', online: 'オンライン',
  ...
  ordersTitle: '注文管理', ordersSubtitle: 'リアルタイムの取引フローと ERP 配信パイプライン', productsTitle: '商品管理', productsSubtitle: '商品カタログ、価格、利用可能在庫を管理', createProduct: '商品を作成', erpTitle: 'ERP 配信', erpSubtitle: '注文イベント、再試行、デッドレターキューを追跡', systemTitle: 'システム状態', systemSubtitle: 'サービス依存関係、拡張機能、売上集計',
