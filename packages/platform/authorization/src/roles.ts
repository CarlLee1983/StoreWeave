...
export const BUILT_IN_ROLES: Record<string, readonly string[]> = {
  admin: ['*'],
  staff: ['catalog:read', 'catalog:write', 'inventory:read', 'inventory:write', 'order:read', 'order:write', 'promotion:read', 'promotion:write', 'promotion:quote', 'customers:manage', 'shipping:read', 'shipping:shipment-read', 'shipping:write', 'erp:read', 'erp:write'],
  readonly: ['catalog:read', 'inventory:read', 'order:read', 'promotion:read', 'shipping:read', 'shipping:shipment-read', 'erp:read'],
  ...
  customer: ['catalog:read', 'inventory:read', 'order:read', 'order:write', 'promotion:quote', 'shipping:read', 'customer:read', 'customer:write', 'cart:read', 'cart:write'],
};
