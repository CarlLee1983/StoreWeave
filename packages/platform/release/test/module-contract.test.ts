...
import { assertModuleContract, runModuleContractChecks, type ModuleContractCheck } from '../src/module-contract';
import { release as baseRelease } from '../../../releases/base/src/runtime';
import type { RuntimeReleaseDefinition } from '../src/runtime';
...
function releaseWith(module: PlatformModule, roles: ReleaseRoleCatalog = GRANTED): RuntimeReleaseDefinition<BaseConfig> {
