...
const cases: readonly CoreCase[] = [
  ...
  {
    id: "catalog.update.strict-unknown-key",
    target: {
      kind: "command",
      name: "commerce.catalog.updateProduct",
      side: "input",
    },
    input: { id: U, name: "Revised", ignored: true },
    issues: [{ code: "unrecognized_keys", path: [] }],
  },
  {
    id: "catalog.update.output-date",
    target: {
      kind: "command",
      name: "commerce.catalog.updateProduct",
      side: "output",
  ...
  {
    id: "catalog.get.requires-id-or-sku",
    target: {
      kind: "query",
      name: "commerce.catalog.getProduct",
      side: "input",
  ...
  {
    id: "catalog.search.output-product",
    target: {
      kind: "query",
      name: "commerce.catalog.searchProducts",
      side: "output",
