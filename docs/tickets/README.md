...
由 `docs/specs/` 的五份規格拆出，共 49 張，之後補了第 50、51、52、53、54 張。依相依順序編號。詞彙見根目錄 `CONTEXT.md`，
決策見 `docs/adr/`（本批為 0013、0014、0015，並補充了 0009）。

**已完成**：01–23、25–54。定價引擎、顧客身分、購物車、優惠券與行銷碼、
...
**還沒做的只有 24（舊版訂單事件下線）**。使用者 2026-08-22 決定「先不要，等一個 minor 週期」：
