...
| [0016](0016-recurring-jobs-by-time-buckets.md) | 週期性工作用時間切片，不用自我續排的鏈 | accepted（排程機制部分由 0039 修訂） |
...
| [0041](0041-base-accounts-are-not-commerce-customers.md) | Base 帳號自成一個生命週期，Customer 由 commerce 擴充 | accepted（B08） |
...
| [0051](0051-story-driver-holds-the-work-graph.md) | 工作圖與順序由 Story Driver 持有，Story 只描述一件工作 | accepted |
